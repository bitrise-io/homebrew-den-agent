class BitriseDenAgentAT2590 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.59.0",
    revision: "8bd58ae83eec9a36a73c011e8a73e90109db12bd"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.59.0/bitrise-den-agent-darwin-arm64.zip"
      sha256 "9b8b8fbc1e7f6b5dd815806e14b320ca42fc49e0aac4dea7150702704808524a"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.59.0/bitrise-den-agent-darwin-amd64.zip"
      sha256 "cd1da1eb585a0da302a378a5c7576e40b26c7461430d4cae1df11ff0cd96b655"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.59.0/bitrise-den-agent-linux-amd64.zip"
      sha256 "01c8e601414fc50848d1276f2a50a8a55539b143f66a019db778c10cfa0ff133"
    end
  end
