class BitriseDenAgentAT2614 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.4",
    revision: "963b3341923589a9b9c0ac85e44591b808f492bf"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.4/bitrise-den-agent-darwin-arm64.zip"
      sha256 "92c57107909e0185cc5df6bfa912965f1d0d988f7f91710835f68b2af4a009ab"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.4/bitrise-den-agent-darwin-amd64.zip"
      sha256 "aaba075e04f6063ad2c919d17c8bc13b2fb0267ef67dd1416b38b589f20c87ff"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.4/bitrise-den-agent-linux-amd64.zip"
      sha256 "1097ec6cb6dfd55c87ff115e037830763deb9bcf0a82974a72188c074872138c"
    end
  end
