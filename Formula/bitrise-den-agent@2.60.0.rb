class BitriseDenAgentAT2600 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.60.0",
    revision: "04194869552f0ecde1599af4b6b43b9cf5c6ec77"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.60.0/bitrise-den-agent-darwin-arm64.zip"
      sha256 "8037268246d978a3106c0d01cd451a7d7eb786cc152b5badb1566615209d69bb"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.60.0/bitrise-den-agent-darwin-amd64.zip"
      sha256 "09a4689d76160ef102471c90286e7aeba3bea408f19f38fa28a32ece26f8cc84"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.60.0/bitrise-den-agent-linux-amd64.zip"
      sha256 "08f727b0933cc18aa9a9b0bef0069d5b30d608b1cee9dad2a013c6bd9211e63c"
    end
  end
