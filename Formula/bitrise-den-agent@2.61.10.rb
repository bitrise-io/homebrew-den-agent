class BitriseDenAgentAT26110 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.10",
    revision: "4b5b4e8b142795171adfa292721ff114fe896d2f"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.10/bitrise-den-agent-darwin-arm64.zip"
      sha256 "5d4dc88b287e7aa241afc1652b393941e33dfed397a13c67aefe508e04300275"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.10/bitrise-den-agent-darwin-amd64.zip"
      sha256 "136139fcedc6ec14e9eae5035c27f65d9af5c5a0d04b7ee336f188400e5e8196"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.10/bitrise-den-agent-linux-amd64.zip"
      sha256 "c15808fe9bb70c34819b3ff3e5b6ac8ef6f1267ddee1c1f805e95558f83df98a"
    end
  end
