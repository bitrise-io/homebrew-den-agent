class BitriseDenAgentAT2612 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.2",
    revision: "aff5b17c5ea41d14c5c18fd7f38500f752736edf"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.2/bitrise-den-agent-darwin-arm64.zip"
      sha256 "58d3d2025b22f422b29b5796904cfb4406db3ee271f49943522d7f5d3a5a92ca"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.2/bitrise-den-agent-darwin-amd64.zip"
      sha256 "05111546f7ad1379b6c5878719d7fcf2b556eb55f5522ee83b32cbbd773e09f9"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.2/bitrise-den-agent-linux-amd64.zip"
      sha256 "b04bc9be7f483467f8c6852fff2585b21546274c36291533ef6116465f0d7a2d"
    end
  end
