class BitriseDenAgentAT2618 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.8",
    revision: "1c629dff3788579fe513ebf9e298db157357e51d"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.8/bitrise-den-agent-darwin-arm64.zip"
      sha256 "a9208465db29dd97354297b4230bb2c230ef4475813523752a593c8086e5445c"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.8/bitrise-den-agent-darwin-amd64.zip"
      sha256 "6b5df5691f1380511d9f17262f90648f038cee8f0b36736da3c287a070c883c5"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.8/bitrise-den-agent-linux-amd64.zip"
      sha256 "84604e4f758f11dfa3fec00081c714810185710a9b25ad5c7e95dae8114369a8"
    end
  end
