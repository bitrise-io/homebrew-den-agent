class BitriseDenAgentAT25711 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.57.11",
    revision: "04d334c15d8bdb12f2739a8831198a51b4a5412d"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.57.11/bitrise-den-agent-darwin-arm64.zip"
      sha256 "5ef5b0a04f8467a4cdb1b47d727bebf6695c9404edf3afae1f20bb77132b5dcc"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.57.11/bitrise-den-agent-darwin-amd64.zip"
      sha256 "bf8a638b45b99b27bbf2007f7d00a8afe1b5389b8fa99e444c797fc9bf0009f3"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.57.11/bitrise-den-agent-linux-amd64.zip"
      sha256 "a7ee8eee8efa46dae9669786d574a169a3f2003d389f26c31e8ebd8d28bf9424"
    end
  end
