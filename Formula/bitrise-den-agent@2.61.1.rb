class BitriseDenAgentAT2611 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.1",
    revision: "70168a039e0af5ba3dfd4d47abec3cb0684f4ad3"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.1/bitrise-den-agent-darwin-arm64.zip"
      sha256 "fb436ee888aaaf8918728233310ad45343820fe211749f8525438d2068ffd4b3"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.1/bitrise-den-agent-darwin-amd64.zip"
      sha256 "c11e83c8488ea9e4eb863cde945862d147eb91749368a8e0800e09d50a405ae4"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.1/bitrise-den-agent-linux-amd64.zip"
      sha256 "11a3e3b3b629a7ba2e29aa311eabe5598df0d67f43b014eb34df9444c3b813ee"
    end
  end
