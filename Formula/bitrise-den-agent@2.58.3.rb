class BitriseDenAgentAT2583 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.58.3",
    revision: "ce88e466e3daa61413cfb8aac9b6dc328327b3f8"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.3/bitrise-den-agent-darwin-arm64.zip"
      sha256 "d6087e90934332b30bbfc4bf0b861693d4cc52fa3fa97804b19783c5b61617c1"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.3/bitrise-den-agent-darwin-amd64.zip"
      sha256 "8378af75b053fd6ede92f96801afcc4dc3f8cc37ea817c91ff531023518b9dab"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.3/bitrise-den-agent-linux-amd64.zip"
      sha256 "4d54aba4213a02e84921175bc6f0339c35b28d5c33e69d8fe000b03ce56f6868"
    end
  end
