class BitriseDenAgentAT2601 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.60.1",
    revision: "5f52d3b62df8d5149eb5b3fd68f3685f2c66903a"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.60.1/bitrise-den-agent-darwin-arm64.zip"
      sha256 "1b844851cdcfa01632db96e1f8bfaf4f574323d973b94570cc1feb1db9264502"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.60.1/bitrise-den-agent-darwin-amd64.zip"
      sha256 "757b3d46b079f640fbaefcc1ec7ee7a0c5f6efa350019f7f4bb72767a99a9f56"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.60.1/bitrise-den-agent-linux-amd64.zip"
      sha256 "8ec12c51fedd2fbf95eb86c5437b9f784f2f51a25857a92ad5c1c891d97e3c5c"
    end
  end
