class BitriseDenAgentAT26111 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.11",
    revision: "b730e2012b6da28caa7653bdfdfc4c0c9e790cbb"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.11/bitrise-den-agent-darwin-arm64.zip"
      sha256 "bb95ac74c1f332a458bfc36e7b5ff92c724b423182f2a87620cdd20844557056"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.11/bitrise-den-agent-darwin-amd64.zip"
      sha256 "cb8782f9a2236c7b3012d529df62343e8851a124b96afaa9f549bcd31c5aee21"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.11/bitrise-den-agent-linux-amd64.zip"
      sha256 "b45b066b84dfd3c19faa5f2a90fa29dad38939dc6637901922de22ff8c86c44a"
    end
  end
