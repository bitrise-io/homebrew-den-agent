class BitriseDenAgentAT2580 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.58.0",
    revision: "ed609e5ab2744409c7e368656bd1f81a3ae7b185"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.0/bitrise-den-agent-darwin-arm64.zip"
      sha256 "86e1b8e2e06b9fcc8e95a04b39fec9d2d6f94c9534b852357c5b020eaea31c17"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.0/bitrise-den-agent-darwin-amd64.zip"
      sha256 "4e2a56a562b37813810965334cbd07f8cddd43b5202edbd90272083a0445aa14"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.0/bitrise-den-agent-linux-amd64.zip"
      sha256 "cdbfe5570bc108539f79acdbf21eef638bc6e5e0b0f5a62cd18f19e3528e44ee"
    end
  end
