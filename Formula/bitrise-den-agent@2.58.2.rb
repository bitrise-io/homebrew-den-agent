class BitriseDenAgentAT2582 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.58.2",
    revision: "cc127793073a47e8b08e5dd2107c8db95999c1be"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.2/bitrise-den-agent-darwin-arm64.zip"
      sha256 "830461dfb6d623e4f51f84668829ed8387c83936dd14d0af342c454333762c37"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.2/bitrise-den-agent-darwin-amd64.zip"
      sha256 "70188cf31f1a6fbf8945c8f9f8f2197c36811bab667241a3df60358f63fbe192"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.58.2/bitrise-den-agent-linux-amd64.zip"
      sha256 "6a1d5a27aafb51580486b7ac8cf6e935337c3bf380e5e87b5d89c2fbfc1218a6"
    end
  end
