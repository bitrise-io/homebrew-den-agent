class BitriseDenAgentAT2615 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.61.5",
    revision: "bbc63454e16c1cef9fc89c939326f699f575cb1a"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.5/bitrise-den-agent-darwin-arm64.zip"
      sha256 "95f59289bbbe4a9eb0c8b176e058198a75d0055803a0ed1782a00d39aa8bc475"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.5/bitrise-den-agent-darwin-amd64.zip"
      sha256 "435fdef2d9fa611e3dad6389b2478700843793200842b49fbc746d92fba1374f"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.61.5/bitrise-den-agent-linux-amd64.zip"
      sha256 "69fcbdc5f1d9a514f7e4d6ba2f066a1eb378b1bc0e3d6a4a3c6e23185e7850b7"
    end
  end
