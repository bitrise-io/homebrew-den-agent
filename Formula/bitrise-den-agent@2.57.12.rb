class BitriseDenAgentAT25712 < Formula
  desc "CLI for Bitrise DEN agent"
  homepage "https://github.com/bitrise-io/bitrise-den-agent"
  url "https://github.com/bitrise-io/bitrise-den-agent.git",
    tag:      "v2.57.12",
    revision: "a15791a84ed78d6c75f47d276b96567d214766d2"
  license ""

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.57.12/bitrise-den-agent-darwin-arm64.zip"
      sha256 "e16477ff0eb185c3eba02948d9bf5a8a7ea46da1d48d1ac4ff1bd45b6db7ee2b"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.57.12/bitrise-den-agent-darwin-amd64.zip"
      sha256 "262d5f040389feca16cb8d0474c55c537701e1f1d9b79f4fd4b2368047b250d5"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bitrise-io/bitrise-den-agent/releases/download/v2.57.12/bitrise-den-agent-linux-amd64.zip"
      sha256 "59910e82883ad850bf725446e6b217eac26cfbabe968d19cc87d1040c32b6247"
    end
  end
