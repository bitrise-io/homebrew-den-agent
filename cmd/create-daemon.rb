...
module Homebrew
  module Cmd
    class CreateDaemon < AbstractCommand
      cmd_args do
        description <<~EOS
          This tool generates a .plist file for the Bitrise DEN agent,
          ...
          The Bitrise DEN agent includes a self-update function, allowing it to
          update itself automatically. By leveraging this functionality, you can
          ensure that the DEN agent is always running the latest version without
          needing to manually manage updates through Homebrew.
        EOS
